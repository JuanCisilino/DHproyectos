...
public class Ejercicio7 {
     ...
     ArrayList<Integer> eliminarPares(ArrayList<Integer> unArrayDeNumeros) {
        ...
        ArrayList<Integer> unArrayDeNumeros2 = new ArrayList<>();
        for (Integer i = 0 ; i < unArrayDeNumeros.size() ; i++) {
            Integer valorPosicion = unArrayDeNumeros.get(i);
            if (valorPosicion % 2 != 0) {
                unArrayDeNumeros2.add(valorPosicion);
            }
        }
unArrayDeNumeros = unArrayDeNumeros2;
        return unArrayDeNumeros;
    }
